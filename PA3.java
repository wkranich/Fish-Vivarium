 ...
 * 
 * For CS480 3D Vivarium Assignment
 * Creates a simulation with a fish and a shark inside a tank.
 * Adding food is possible by pressing F or f
 * Resetting fish (whether alive or dead) is possible by pressing N or n
 * 
...
private final int DEFAULT_WINDOW_WIDTH =900;
...
private GLUT glut;
  ...
  public PA3()
  {
    ...
    setTitle("CS480/CS680 : Fish Tank Simulator");
   ...
   * KeyListener
   * 
   * F/f: Add food to the tank
   * N/n: Reset fish at anytime, but mostly for reanimation after fish has been killed.
   * Q/q: Quit program
